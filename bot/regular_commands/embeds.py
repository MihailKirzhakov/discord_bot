...
def start_rcd_embed(date: str) -> discord.Embed:
    ...
    embed = discord.Embed(
        ...
        description=(
            ...
            'ПВП офицеров! Если в какой-то момент канал для вас становится '
            'невидимым, значит приём заявок закрыт, а список РЧД является закрытым! '
            'В таком случае, если вы входите в состав РЧД, бот вам отправит '
            'уведомление о том, что вы в составе и на каком классе тебя ждут '
            f'в 2️⃣0️⃣:4️⃣5️⃣ {date}. 💪_'
        ),
        color=0xfffb00
    )
