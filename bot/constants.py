...
ANSWER_IF_DUPLICATE_NAME = (
    '_Игрок с таким ником уже имеется на нашем сервере.\n'
    'Введи свой игровой никнейм!\n\n'
    'Если ты вводишь все правильно, но при этом видишь это собщение, '
    'обратись к СтопарьВодяры в ЛС_!'
)
...
что_доделать = (
    '1. Придумать алгоритм проверки уже отправленных заявок',
    '2. Разобраться с опросами'
)